...
import { FaMapMarkerAlt, FaTruck, FaBox, FaCalendarAlt, FaCheckCircle } from 'react-icons/fa';
        ...
        <div className="lg:col-span-1 bg-white rounded-lg overflow-hidden">
          <div className="p-4 shadow rounded md border border-gray-200 mb-2">
            <h2 className="text-lg font-semibold flex items-center gap-2">
              <FaMapMarkerAlt className="text-red-500" /> Route Overview
            </h2>
            <div className="p-4">
        ...
        <div className="rounded-lg shadow bg-gray-50 overflow-hidden">
          ...
          <div className="p-4 space-y-4 text-sm">
            ...
            <button
              ...
              disabled={isBooking}
              className={`w-full py-3 px-4 rounded-lg font-medium cursor-pointer text-white flex items-center justify-center gap-2 ${
                isBooking ? 'bg-black' : 'bg-black hover:bg-black/80'
              }`}
            >
              {isBooking ? (
                <>
